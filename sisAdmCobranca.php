...
/**
 * Teste para implementar QR code
 */
...
<body>
    ...
    <div class="boxfuncoes">
            <a class="botaocobrar" href="sisAdm.php">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                while ($user_data = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>" . $user_data['status_pix'] . "</td>";
...
<script>
    ...
    function searchData() {
        window.location = 'sisAdmCobranca.php?search=' + search.value;
    }
</script>
