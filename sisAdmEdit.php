...
<body>
    ...
    <div class="boxfuncoes">
            ...
            <a class="botaoeditar" href="sisAdm.php">
            ...
            <tbody>
                ...
                while ($user_data = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>
                        ...
                        <a class='btn btn-primary botao-editar' href='edit.php?id=$user_data[id]'>
...
<script>
        ...
        function searchData()
        {
            ...
            window.location = 'sisAdmEdit.php?search='+search.value;
